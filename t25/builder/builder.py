...
##### t25 TMA-1 STM32 firmware build and flash process START #####
def stm32():
    ...
    return 0
##### t25 TMA-1 STM32 firmware build and flash process end #####


##### t25 TMA-1 ESP32 firmware build and flash process START #####
def esp32():
    print("INFO: checking toolchain...")
    ...
    return 0
##### t25 TMA-1 ESP32 firmware build and flash process end #####
